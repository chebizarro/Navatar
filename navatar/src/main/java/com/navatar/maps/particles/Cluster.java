...
public class Cluster<T extends State> implements Comparable<Cluster<T>> {
     ...
     * Class constructor.
     *
     * @param mean The mean value of the cluster.
     */
     ...
     *
     * @param state The state to count the distance from.
     ...
     *
     * @param state The state to count the square distance from.
     ...
     *
     * @param cluster The cluster to count the distance from this cluster.

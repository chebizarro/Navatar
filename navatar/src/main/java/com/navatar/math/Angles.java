...
public class Angles {
     ...
     *
     * @param angles The angles to be averaged. Values can be over 360 or under 0. If the angles array
     ...
     * @throws NullPointerException      if the angles parameter is null.
     * @throws InvalidParameterException if the angles array is empty.
     */
     ...
     * @param weights The weights to be used for calculating the average.
     ...
     * @throws NullPointerException      if the angles array or the weights array is null.
     * @throws InvalidParameterException if the two arrays do not have the same size or if any of the weights provided is
     *                                   negative.
     */
     ...
     *
     * @param angle The angle to be discretized.
     ...
     *
     * @param angle The compass angle to be transformed.
     ...
     *
     * @param angle The polar angle to be transformed.
